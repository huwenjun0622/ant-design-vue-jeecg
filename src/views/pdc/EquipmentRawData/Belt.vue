<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="设备名称">
              <a-input placeholder="请输入设备名称" v-model="queryParam.deviceId"></a-input>
            </a-form-item>
          </a-col>
    ...
    <!-- 表单区域 -->
    <belt-model ref="modalForm" @ok="modalFormOk"></belt-model>
  </a-card>
</template>
      ...
      return {
        ...
        columns: [
         ...
         
          {
            title: '输煤设备运行状态',
            align: "center",
            dataIndex: 'coalequipmentState'
          },
          {
            title: '当前状态开始时刻',
            align: "center",
            dataIndex: 'coalequipmentStarttime'
          },
          {
            title: '上个运行状态的开始时刻',
            align: "center",
            dataIndex: 'coalequipmentEndtime'
          },
          {
            title: '当前状态持续时长(s)',
            align: "center",
            dataIndex: 'coalequipmentRuntime'
          },
          {
            title: '振动状态',
            align: "center",
