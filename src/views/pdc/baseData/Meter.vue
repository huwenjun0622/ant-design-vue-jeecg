    ...
    <a-card :bordered="false">
      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline" @keyup.enter.native="searchQuery">
          <a-row :gutter="24">
            <a-col :md="6" :sm="8">
              <a-form-item label="计量仪器名称">
                <a-input placeholder="请输入计量仪器名称" v-model="queryParam.instrumentName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="计量仪器编号">
                <a-input placeholder="请输入计量仪器编号" v-model="queryParam.instrumentCode"></a-input>
              </a-form-item>
            </a-col>
      ...
      <!-- 表单区域 -->
      <meter-modal ref="modalForm" @ok="modalFormOk"></meter-modal>
    </a-card>
  </template>
  
  <script>
    import MeterModal from './modules/MeterModal.vue'
