  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="煤矿名称">
              <a-input placeholder="请输入煤矿名称" v-model="queryParam.mineName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="子公司名称">
              <a-input placeholder="请输入子公司名称" v-model="queryParam.parentCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="标识">
              <j-dict-select-tag :triggerChange="true" dictCode="appType" v-model="queryParam.appType" placeholder="请选择标识">
               </j-dict-select-tag>
            </a-form-item>
          </a-col>
    ...
    <!-- 表单区域 -->
    <factory-and-mine-modal ref="modalForm" @ok="modalFormOk"></factory-and-mine-modal>
  </a-card>
</template>

<script>
  import FactoryAndMineModal from './modules/FactoryAndMineModal'
