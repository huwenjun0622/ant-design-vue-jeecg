<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <transmission-equipment-model ref="modalForm" @ok="modalFormOk"></transmission-equipment-model>
  </a-card>
</template>

<script>
  import TransmissionEquipmentModel from './modules/TransmissionEquipmentModel'
